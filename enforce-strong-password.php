...
_lugin URI: http://zaantar.eu
Description: Po aktivaci vynutí dostatečně silné heslo při jeho změně v uživatelském profilu. <strong>Vyvinuto a určeno pro blogosphere.cz</strong>
Version: 1.0
Author: Zaantar
...
*/
	if ( $enforce && !$errors->get_error_data("pass") && $_POST["pass1"] && esp_password_strength( $_POST["pass1"], $_POST["user_login"] ) != 4 ) {
			$errors->add( 'pass', 'CHYBA: Prosím zadejte <strong>silné</strong> heslo. Snaha o prolomení ochrany blogosphere již byla v minulosti zaznamenána.' );
	}
	return $errors;
}
